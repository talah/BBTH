...
public class UICheckBox extends UIControl {
	...
	private int _bg_color, _fg_color, _down_color, _disabled_color, bg_end_color;
	...
	public UICheckBox(String label) {
		...
		if (label != null && !label.equals("")) {
			...
			setSize(UIDefaultConstants.UI_CHECKBOX_BUTTON_WIDTH, UIDefaultConstants.UI_CHECKBOX_LABEL_HEIGHT);
		}
	...
	public void setBackgroundColor(int color) {
		...
		_bg_gradient = new LinearGradient(_button_rect.left, _button_rect.top, _button_rect.left, _button_rect.bottom, color, bg_end_color,Shader.TileMode.MIRROR);
	}
	...
	public void setDisabledColor(int color) {
		...
		_disabled_gradient = new LinearGradient(_button_rect.left, _button_rect.top, _button_rect.left, _button_rect.bottom, s_color, color, Shader.TileMode.MIRROR);
	}
	...
	public void setButtonDownColor(int color)
	{
		...
		_down_gradient = new LinearGradient(_button_rect.left, _button_rect.top, _button_rect.left, _button_rect.bottom, _down_color, end_color, Shader.TileMode.MIRROR);
	}
	
	private void generatePath()
	{
		_checkPath.reset();
		_checkPath.moveTo(_button_rect.left + 3, _button_rect.top + UIDefaultConstants.UI_CHECKBOX_BUTTON_WIDTH * 0.25f);
		_checkPath.lineTo(_button_rect.centerX(), _button_rect.centerY());
		_checkPath.lineTo(_button_rect.centerX() + UIDefaultConstants.UI_CHECKBOX_BUTTON_WIDTH - 2, _button_rect.top - UIDefaultConstants.UI_CHECKBOX_BUTTON_WIDTH * 0.25f);
		_checkPath.lineTo(_button_rect.centerX(), _button_rect.centerY() + UIDefaultConstants.UI_CHECKBOX_BUTTON_WIDTH * 0.25f);
		_checkPath.lineTo(_button_rect.left + 3, _button_rect.top + UIDefaultConstants.UI_CHECKBOX_BUTTON_WIDTH * 0.25f);
	}
	...
	public void setBounds(float left, float top, float right, float bottom) {
		...
		_label.setPosition(left + 1.5f * UIDefaultConstants.UI_CHECKBOX_BUTTON_WIDTH, top);
	...
	public void onDraw(Canvas canvas) {
		...
		_paint.setShader((isDisabled ? _disabled_gradient : (isDown ? _down_gradient : _bg_gradient)));
		canvas.drawRect(_button_rect, _paint);
