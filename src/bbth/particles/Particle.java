 ...
 * since they are controlled entirely by the particle system in the same package.
 * @author jardini
 */
public class Particle {
	...
	void draw(Canvas canvas, Paint paint) {
		...
		case LINE:
			...
			canvas.drawLine(_xPos - dx, _yPos - dy, _xPos + dx, _yPos + dy, paint);
			break;
	...
	public final Particle shrink(float shrink) { _shrink = shrink; return this; }
	public final Particle shrink(float min, float max) { _shrink = MathUtils.randInRange(min, max); return this; }
	public final Particle angle(float angle) { _angle = angle; return this; }
	public final Particle angle(float min, float max) { _angle = MathUtils.randInRange(min, max); return this; }
	public final Particle angularVelocity(float angularVelocity) { _angularVelocity = angularVelocity; return this; }
	public final Particle angularVelocity(float min, float max) { _angularVelocity = MathUtils.randInRange(min, max); return this; }
	public final Particle gravity(float gravity) { _gravity = gravity; return this; }
