...
public class CircleShape extends Shape {
	...
	public void draw(Canvas canvas, Paint paint) {
		canvas.drawCircle(worldTransform.offset.x, worldTransform.offset.y, radius, paint);
	}

	@Override
	public void recordPoints(SeparatingAxisTheorem theorem) {
		Point p = worldTransform.offset;
		theorem.recordPoint(p.x - theorem.axisX * radius, p.y - theorem.axisY * radius);
		theorem.recordPoint(p.x + theorem.axisX * radius, p.y + theorem.axisY * radius);
	}
	...
	public void applyTheorem(SeparatingAxisTheorem theorem, CircleShape other) {
		theorem.changeAxis(other.worldTransform.offset.x - worldTransform.offset.x, other.worldTransform.offset.y - worldTransform.offset.y);
