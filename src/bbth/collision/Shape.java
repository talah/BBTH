...
public abstract class Shape {
	...
	public abstract boolean isCrossingLineSegment(float originX, float originY, float rayX, float rayY);
	...
	public abstract void applyTheorem(SeparatingAxisTheorem theorem, CircleShape other);

	public abstract void applyTheorem(SeparatingAxisTheorem theorem, PolygonShape other);

	public abstract void applyTheorem(SeparatingAxisTheorem theorem, CompoundShape other);
}
