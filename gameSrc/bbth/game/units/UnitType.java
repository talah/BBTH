...
public enum UnitType {
	ATTACKING {
		@Override
		public Unit createUnit(UnitManager manager, Team team, Paint p, ParticleSystem particleSystem) {
	...
	WALL {
		@Override
		public Unit createUnit(UnitManager manager, Team team, Paint p, ParticleSystem particleSystem) {
			return new WallUnit(new Wall(0, 0, 0, 0), manager, team, p, particleSystem);
		}
	};
	
	public abstract Unit createUnit(UnitManager manager, Team team, Paint p, ParticleSystem particleSystem);
