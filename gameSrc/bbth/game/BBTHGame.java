...
public class BBTHGame extends Game {
	...
	public static final GameStatusMessageScreen DISCONNECT_SCREEN = new GameStatusMessageScreen("You have been disconnected", null);
	public static final GameStatusMessageScreen WIN_SCREEN = new GameStatusMessageScreen("Congratulations! You won!", null);
	public static final GameStatusMessageScreen LOSE_SCREEN = new GameStatusMessageScreen("Oh noes, you lost :(", null);
	public static final GameStatusMessageScreen TIE_SCREEN = new GameStatusMessageScreen("It's a tie!", null);
